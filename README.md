...
● File 1: You must submit a SQL document called _Assignment4_Part1. This document must include ALL commands required to create the banking database (the DDL).

● File 2: You must submit a SQL document called _Assignment4_Part2. This document must include Queries 1- 7 found in part 2 of this assignment.

● File 3: You must submit a SQL document called _Assignment4_Part3. This document must include Queries 8-12 found in part 3 of this assignment.
...
ASSIGNMENT CONTINUED ON NEXT PAGE* Database Assumptions:
...
ASSIGNMENT CONTINUED ON NEXT PAGE* PART 2 Banking Database Queries
